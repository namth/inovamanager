        ...
        <div class="invoice-header">
            ...
            <p id="invoice-header-status">
                ...
                <span class="btn btn-sm <?php echo $badge_class; ?>"
                    style="font-weight: bold; text-transform: uppercase;"><?php echo $status_options[$invoice->status] ?? $invoice->status; ?></span>
            </p>
        </div>
        ...
        <div class="invoice-content">
            ...
            <div class="invoice-info-row">
                <div class="info-section">
                    <h3 class="text-muted"><i class="ph ph-building me-2"></i>Thông tin nhà cung cấp</h3>
                ...
                <div class="info-section">
                    <h3 class="text-muted"><i class="ph ph-building me-2"></i>Thông tin khách hàng</h3>
                    <table class="info-table">
                        <tr>
...
<script>
    jQuery(document).ready(function ($) {
        /**
        * Hide QR section and update header - admin only
        * Requires refresh to show again
        */
        var hideQrBtn = $('#hide-qr-btn');
        var qrSection = $('#qr-section');
        var headerTitle = $('#invoice-header-title');
        var headerSubtitle = $('#invoice-header-subtitle');
        var headerStatus = $('#invoice-header-status');
        ...
        if (hideQrBtn.length) {
            hideQrBtn.on('click', function (e) {
                ...
                // Update header
                headerTitle.text('PHỤ LỤC');
                headerSubtitle.text('Theo hợp đồng số 2026-HDBT0701');
                headerStatus.hide();
            });
        }
    });
