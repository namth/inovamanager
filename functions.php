...
/**
 * ====================================================================
 * WEBHOOK FUNCTIONS - Send data to n8n webhook
 * ====================================================================
 */

/**
 * Send webhook data to configured endpoint
 * 
 * @param array $data Data to send
 * @param string $event_type Type of event (renewal_invoice, expiry_check)
 ...
 * 
 * @param int $invoice_id Invoice ID
 * @param int $customer_id Customer user ID (Inova ID)
...
/**
 * Hook to send webhook when invoice is created (for renewal invoices)
 * Add this to the invoice creation function
 */
...
/**
 * Prepare expiry check data for webhook
 * 
 * @param array $expiring_domains Array of expiring domains
 * @param array $expiring_hostings Array of expiring hostings
 * @param array $expiring_maintenance Array of expiring maintenance packages
 * @return array Expiry data
 */
...
/**
 * Hook to send webhook for expiry check
 * Call this from check_and_send_expiry_emails()
 */
