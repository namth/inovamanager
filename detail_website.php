                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <?php $decrypted_password = im_decrypt_password($website->admin_password); ?>
                                                        <input type="password" class="form-control" id="admin-password" value="<?php echo esc_attr($decrypted_password); ?>" readonly>
