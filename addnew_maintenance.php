    ...
    <div class="row">
        <div class="col-lg-12" id="relative">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-column">
                ...
                <a href="<?php echo $user_id ? home_url('/user-detail/?user_id=') . $user_id : home_url('/danh-sach-bao-tri/'); ?>"
                    class="abs-top-left nav-link">
                                        ...
                                        <div class="card-body">
                                            <?php if (!$website_id): ?>
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="js-example-basic-single w-100" name="selected_website_id"
                                                        id="selected_website_id">
                                                ...
                                                ");
                                                    ...
                                                    <small class="form-text text-muted">Chọn website để tự động điền chủ sở hữu
                                                        và liên kết</small>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control height-auto" id="notes" rows="3"
                                                    placeholder="Ghi chú" name="notes"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" step="1000" class="form-control" id="monthly_fee"
                                                    name="monthly_fee" value="100000" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="price_per_cycle_display"
                                                            readonly>
                                                        <small class="form-text text-muted">Tự động tính: Phí hàng tháng ×
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <small class="form-text text-muted">Số tháng được tính tiền mỗi lần
                                                            thanh toán</small>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="actual_revenue_display" class="fw-bold">Doanh thu thực tế
                                                    (VNĐ)</label>
                                                <input type="text" class="form-control" id="actual_revenue_display"
                                                    readonly>
