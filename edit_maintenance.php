...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['post_maintenance_field']) && wp_verify_nonce($_POST['post_maintenance_field'], 'post_maintenance')) {
        ...
        $total_months_registered = intval($_POST['total_months_registered']);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (!empty($website->admin_url)): ?>
                                                            <a href="<?php echo esc_url($website->admin_url); ?>" target="_blank"
                                                                class="nav-link">
                                                                <span class="text-truncate d-inline-block"
                                                                    style="max-width: 200px;"><?php echo $website->admin_url; ?></span>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo home_url('/edit-website/?website_id=' . $website->id); ?>"
                    ...
                    if (isset($notification)) {
                        ...
                        <form class="forms-sample col-md-8 col-lg-10 d-flex flex-column" action="" method="post">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="js-example-basic-single w-100" name="owner_user_id"
                                                    id="owner_user_id" required>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="order_code" name="order_code"
                                                    placeholder="Mã gói bảo trì"
                                                    value="<?php echo esc_attr($maintenance->order_code); ?>">
                                                <small class="form-text text-muted">Để trống để tự động tạo mã dựa trên
                                                    khách hàng mới</small>
                                            </div>

                                            <div class="form-group mb-3">
                                                <label for="renew_date" class="fw-bold">Ngày gia hạn <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group date datepicker">
                                                    <input type="text" class="form-control" id="renew_date"
                                                        name="renew_date" placeholder="<?php echo date('d/m/Y'); ?>"
                                                        required
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="status" class="fw-bold">Trạng thái <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-control" id="status" name="status" required>
                                                    <option value="NEW" <?php selected($maintenance->status, 'NEW'); ?>>Chờ
                                                        thanh toán</option>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control height-auto" id="notes" rows="3"
                                                    placeholder="Ghi chú"
                                                    name="notes"><?php echo esc_textarea($maintenance->notes); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card mb-4">
                                        <div class="d-flex card-header btn-secondary">
                                            ...
                                            <span class="badge border-radius-9 bg-inverse-info text-info ms-2">Tự động
                                                tính</span>
                                        </div>
                                        <div class="card-body">
                                            <div class="form-group mb-3">
                                                <label for="monthly_fee" class="fw-bold">Phí hàng tháng (VNĐ) <span
                                                        class="text-danger">*</span></label>
                                                <input type="number" step="1000" class="form-control" id="monthly_fee"
                                                    name="monthly_fee" value="<?php echo $maintenance->monthly_fee; ?>"
                                                    required>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="price_per_cycle_display" class="fw-bold">Giá mỗi chu kỳ
                                                            (VNĐ)</label>
                                                        <input type="text" class="form-control" id="price_per_cycle_display"
                                                            readonly
                                                            value="<?php echo number_format($maintenance->price_per_cycle, 0, ',', '.') . ' ₫'; ?>">
                                                        <small class="form-text text-muted">Phí hàng tháng ×
                                                            Chu kỳ thanh toán</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="billing_cycle_months" class="fw-bold">Chu kỳ thanh toán
                                                            <span class="text-danger">*</span></label>
                                                        <select class="form-control" id="billing_cycle_months"
                                                            name="billing_cycle_months" required>
                                                            <option value="1" <?php selected($maintenance->billing_cycle_months, 1); ?>>1 tháng
                                                            </option>
                                                            <option value="3" <?php selected($maintenance->billing_cycle_months, 3); ?>>3 tháng
                                                            </option>
                                                            <option value="6" <?php selected($maintenance->billing_cycle_months, 6); ?>>6 tháng
                                                            </option>
                                                            <option value="12" <?php selected($maintenance->billing_cycle_months, 12); ?>>12
                                                                tháng</option>
                                                            <option value="24" <?php selected($maintenance->billing_cycle_months, 24); ?>>24
                                                                tháng</option>
                                                            <option value="36" <?php selected($maintenance->billing_cycle_months, 36); ?>>36
                                                                tháng</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label for="total_months_registered" class="fw-bold">Số tháng đã sử
                                                            dụng <span class="text-danger">*</span></label>
                                                        <input type="number" class="form-control"
                                                            id="total_months_registered" name="total_months_registered"
                                                            value="<?php echo $maintenance->total_months_registered; ?>"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" step="1000" class="form-control" id="discount_amount"
                                                    name="discount_amount"
                                                    value="<?php echo $maintenance->discount_amount; ?>">
                                            </div>

                                            <div class="form-group mb-3">
                                                <label for="actual_revenue_display" class="fw-bold">Doanh thu thực tế
                                                    (VNĐ)</label>
                                                ...
                                                <small class="form-text text-muted">Tự động tính: Giá chu kỳ - Chiết
                                                    khấu</small>
                                            </div>
                                            ...
                                            <div class="alert alert-info">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <small
                                                            id="expiry_date_display"><?php echo date('d/m/Y', strtotime($maintenance->expiry_date)); ?></small>
                                                    </div>
                                                    <div class="col-6">
                            ...
                            <div class="form-group d-flex justify-content-center mt-3">
                                ...
                                <a href="<?php echo home_url('/danh-sach-bao-tri/'); ?>"
...
<script>
    jQuery(document).ready(function ($) {
        ...
        function calculateValues() {
            ...
            const totalMonths = parseInt(totalMonthsInput.value) || 1;
        ...
        if (billingCycleSelect) billingCycleSelect.addEventListener('change', function () {
            totalMonthsInput.value = this.value;
            calculateValues();
        });
        if (discountInput) discountInput.addEventListener('input', calculateValues);
        if (totalMonthsInput) totalMonthsInput.addEventListener('input', calculateValues);
