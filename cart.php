                        ...
                        <?php foreach ($cart_by_customer as $user_id => $customer_cart): ?>
                            <div class="card mb-4 border">
                                <div class="card-header bg-primary text-white">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">
                                            ...
                                            <span
                                                class="badge bg-light text-dark ms-2"><?php echo esc_html($customer_cart['customer_code']); ?></span>
                                        </h5>
                                        <span class="badge bg-light text-dark"><?php echo count($customer_cart['items']); ?>
                                            dịch vụ</span>
                                    </div>
                                </div>
                                <div class="card-body">
                                                ...
                                                foreach ($customer_cart['items'] as $index => $cart_item):
                                                    ...
                                                    switch ($cart_item->service_type) {
                                                        case 'domain':
                                                            ...
                                                            SELECT d.domain_name, d.expiry_date, d.status, COALESCE(pc.renew_price, pc.register_price, 0) AS price
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($expiry_date): ?>
                                                                <span
                                                                    class="badge <?php echo strtotime($expiry_date) < time() ? 'bg-danger' : 'bg-success'; ?>">
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-sm btn-danger remove-cart-item"
                                                                data-cart-id="<?php echo $cart_item->id; ?>">
                                ...
                                <div class="card-footer text-end">
                                    <a href="<?php echo home_url('/them-moi-hoa-don/?user_id=' . $user_id . '&from_cart=1'); ?>"
