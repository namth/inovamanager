<?php
/* 
    Template Name: Edit Domain Simple
*/
            ...
            <div class="mt-3">
                <div class="wrapper d-flex justify-content-center align-items-center flex-column py-2">
                    ...
                    if (isset($notification)) {
                        ...
                        echo '<a href="' . home_url('/detail-domain/?domain_id=' . $domain_id) . '" class="btn btn-info btn-icon-text ms-2 d-flex align-items-center border-radius-9">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="domain_name" name="domain_name" placeholder="example.com" value="<?php echo esc_attr($domain->domain_name); ?>" required>
                                        <button type="button" class="btn btn-secondary" id="lookup-whois-btn">
                                            <i class="ph ph-magnifying-glass me-1"></i> Looking up
                                        </button>
                                    </div>
                                    <small class="form-text text-muted"><i class="ph ph-info me-1"></i>Nhập tên miền. Nhấn "Looking up" để cập nhật ngày đăng ký và hết hạn từ WHOIS (chỉ áp dụng với tên miền quốc tế)</small>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group date datepicker">
                                        <input type="text" class="form-control" id="registration_date" name="registration_date" placeholder="dd/mm/yyyy" value="<?php echo $domain->registration_date ? date('d/m/Y', strtotime($domain->registration_date)) : ''; ?>">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group date datepicker">
                                        <input type="text" class="form-control" id="expiry_date" name="expiry_date" placeholder="dd/mm/yyyy" value="<?php echo $domain->expiry_date ? date('d/m/Y', strtotime($domain->expiry_date)) : ''; ?>">
                                        <span class="input-group-text bg-secondary text-white">
                                            <i class="ph ph-calendar"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="management_username" name="management_username" placeholder="Username" value="<?php echo esc_attr($domain->management_username); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control height-auto" id="notes" rows="3" placeholder="Ghi chú thêm về tên miền" name="notes"><?php echo esc_textarea($domain->notes); ?></textarea>
                                </div>
                            </div>
                        </div>
