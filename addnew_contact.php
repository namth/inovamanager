            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between align-items-center mb-3 flex-column">
                        ...
                        <a href="<?php echo home_url('/partner/?id=') . $user_id; ?>" class="abs-top-left nav-link">
                    ...
                    <div class="mt-3">
                        <div class="wrapper d-flex justify-content-center align-items-center flex-column py-2">
                            ...
                            if (isset($notification)) {
                                ...
                                echo '<a href="' . home_url('/partner/?id=' . $user_id) . '" class="btn btn-dark btn-icon-text me-2 d-flex align-items-center border-radius-9">
