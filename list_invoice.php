...
if (!empty($search_term)) {
    $where_clause .= $wpdb->prepare(
        " AND (i.invoice_code LIKE %s OR u.name LIKE %s OR u.user_code LIKE %s)",
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Tìm kiếm hóa đơn..."
                                        name="search" value="<?php echo esc_attr($search_term); ?>">
                            ...
                            <div class="col-md-2 mb-3">
                                <div class="input-group datepicker">
                                    <input type="text" class="form-control" placeholder="Từ ngày" name="date_from"
                            ...
                            <div class="col-md-2 mb-3">
                                <div class="input-group datepicker">
                                    <input type="text" class="form-control" placeholder="Đến ngày" name="date_to"
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="d-flex">
                                    ...
                                    <a href="<?php echo home_url('/danh-sach-hoa-don/'); ?>"
                                        class="btn btn-secondary d-flex align-items-center">Đặt lại</a>
                                </div>
                            </div>
                        </div>
                    </form>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <?php if (is_inova_admin()): ?>
                                                        <?php if ($invoice->status == 'draft'): ?>
                                                            <a href="<?php echo home_url('/tao-hoa-don/?invoice_id=' . $invoice->id); ?>"
                                                                class="nav-link text-warning me-2" title="Chỉnh sửa">
                                                                <i class="ph ph-pencil-simple fa-150p"></i>
                                                            </a>

                                                            <a href="<?php echo home_url('/tao-hoa-don/?invoice_id=' . $invoice->id . '&finalize=1'); ?>"
                                                                class="nav-link text-success me-2" title="Hoàn tất hóa đơn">
                                                                <i class="ph ph-check-circle fa-150p"></i>
                                                            </a>
                                                        <?php endif; ?>

                                                        <?php if (in_array($invoice->status, ['pending', 'draft'])): ?>
                                                            <a href="<?php echo home_url('/chi-tiet-hoa-don/?invoice_id=' . $invoice->id . '&action=payment'); ?>"
                                                                class="nav-link text-success me-2" title="Đánh dấu đã thanh toán">
                    ...
                    <?php if ($total_pages > 1): ?>
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <div>
                                Hiển thị <?php echo min($per_page, count($invoices)); ?> / <?php echo $total_items; ?> hóa
                                đơn
                            </div>
                            <div>
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        <?php if ($current_page > 1): ?>
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="<?php echo add_query_arg('paged', $current_page - 1, $_SERVER['REQUEST_URI']); ?>"
                                                    aria-label="Previous">
                                        ...
                                        for ($i = $start_page; $i <= $end_page; $i++):
                                            ...
                                            <li class="page-item <?php echo $i == $current_page ? 'active' : ''; ?>">
                                                <a class="page-link"
                                                    href="<?php echo add_query_arg('paged', $i, $_SERVER['REQUEST_URI']); ?>">
                                                    <?php echo $i; ?>
                                                </a>
                                            </li>
                                        <?php endfor; ?>
