                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <input type="password" class="form-control" id="hosting-password" value="<?php echo esc_attr($hosting->management_password); ?>" readonly>
                                                        <button class="btn btn-inverse-secondary border-secondary toggle-password" type="button">
                                                            <i class="ph ph-eye"></i>
                                                        </button>
                                                        <button class="btn btn-secondary" type="button" onclick="navigator.clipboard.writeText('<?php echo esc_js($hosting->management_password); ?>')">
                                                            <i class="ph ph-copy"></i>
                                                        </button>
                                                    </div>
                                                </td>
